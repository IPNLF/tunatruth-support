...
| Suggested donation amounts (£50/£200/£500, updated 2026-09-10) | `config.js` → `presetAmounts` | No longer labelled on-page as provisional (removed 2026-09-08 — felt like distracting caveat text) — but still illustrative, not confirmed; real amounts TBC |
